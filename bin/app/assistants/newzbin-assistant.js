...
this.controller.listen('webView', Mojo.Event.webViewLinkClicked, this.handleLinkClicked.bind(this));
...
NewzbinAssistant.prototype._updateLoadProgress = function(image) {
